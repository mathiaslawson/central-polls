          ...
          <Box display='grid'>
            ...
            <Box display={smallScreens ? 'flex': 'grid'} marginTop='2rem' justifyContent='space-between' height='75vh' width='100%' gap='1rem'>
                <Box width={smallScreens ? '40%' : '100%'} backgroundColor='#fff' borderRadius='0.5rem' padding='1rem' display='grid' justifyContent='center'>
                      ...
                      <Typography textAlign='center' marginTop='0.5rem' color='#751919' fontWeight='900'># {details.candidateSlogan}#</Typography>
                      </Box>
                </Box>
                <Box  padding='0.7rem'  width={smallScreens ? '100%': '100%'} height={smallScreens ? 'inherit': 'max-content'}  borderRadius='0.5rem' display='grid' gap='1rem'>

                  {/* Basic Information */}
                     <Box backgroundColor='white' width='100%' height='35vh' borderRadius='0.5rem'>
                         <Box padding='1rem'>
                             <Typography variant='h4' fontWeight='bolder' color='#751919'>Basic Information</Typography>
                             <Box display='flex' justifyContent='space-evenly' marginTop='1rem'>
                                 <Box display='grid' textAlign='center' justifyContent='left'>
                             ...
                             <Box marginTop='2rem'>
                              <Typography fontWeight='bolder' variant='h4' color='#751919'>
                                Experience
                              </Typography>
                  ...
                  {/*Campaign Promise  */}
                     <Box backgroundColor='white' width='100%' height='40vh' borderRadius='0.5rem' padding='1rem'>
                            <Box display='grid'>
                            <Typography fontWeight='bolder' variant='h4' color='#751919' textAlign='center'>
                                Campaign Promises
                            </Typography>
                            <Typography marginTop='2rem' fontWeight='100' textAlign='center'>
                              Eyyy plenty promises like this, can you do them ...
                              Eyyy plenty promises like this, can you do them ...
                              Eyyy plenty promises like this, can you do them ...
                              Eyyy plenty promises like this, can you do them ...
                              Eyyy plenty promises like this, can you do them ...
